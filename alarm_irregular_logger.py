...
class AlarmLogger:
    ...
    def __init__(self, default_output: LogOutput = LogOutput.BOTH) -> None:
    ...
    def _write(
        ...
        """ログ記録の共通処理"""
        output = output or self.default_output  # ←ここが正解
    ...
    def info(
        ...
        self._write(
            ...
            context=context,
            timestamp=timestamp,
            output=output if output else self.default_output,
        )
